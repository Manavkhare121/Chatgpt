...
const Home = () => {
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:8000/api/chat", { withCredentials: true })
      .then(response => {
  ...
  const getMessages = async (chatId) => {
   ...
   const response = await  axios.get(`http://localhost:8000/api/chat/messages/${chatId}`, { withCredentials: true })
